...
class processRawData():
    ...
    def plotFeatures(self,data_dframe,f1):
        ...
        plt.savefig('plots_2017/plot_'+feat1+'.png')


if __name__ == '__main__':
    dataTrain = '/Users/ioana/Desktop/DS4A_workspace/project_mentalHealth/OSMI_2017.csv'
    ...
    dataProcessed.to_csv('dataAll_2017.csv')
    dataqA.to_csv('dataqA_2017.csv')
    dataqB.to_csv('dataqB_2017.csv')
